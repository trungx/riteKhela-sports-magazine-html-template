    ...
    <div class="ritekhela-wrapper">
        ...
        <div class="ritekhela-subheader">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1>Shop Grid W Left Sidebar</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="ritekhela-shop ritekhela-shop-view1">
                                <ul class="row">
                                    <li class="col-md-6">
                                        <figure><a href="#"><img src="extra-images/shop-grid-img5.jpg" alt=""></a></figure>
                                        <div class="ritekhela-shop-grid-text">
                                            <h2><a href="#">Atlantic Sneaker</a></h2>
                                            <span class="price-cart"><del>$ 30.00</del> $19.00</span>
                                            <p>Lorem ipsum dolor sit amet, consectet adipiscing elit. Vestibulum a nunc du rabitur dignissim.</p>
                                            <a href="#" class="ritekhela-shop-btn ritekhela-bgcolor ritekhela-color-two">Add To Cart</a>
                                        </div>
                                    </li>
                                    <li class="col-md-6">
                                        <figure><a href="#"><img src="extra-images/shop-grid-img6.jpg" alt=""></a></figure>
                                        <div class="ritekhela-shop-grid-text">
                                    ...
                                    <li class="col-md-6">
                                        <figure><a href="#"><img src="extra-images/shop-grid-img7.jpg" alt=""></a></figure>
                                        <div class="ritekhela-shop-grid-text">
                                    ...
                                    <li class="col-md-6">
                                        <figure><a href="#"><img src="extra-images/shop-grid-img8.jpg" alt=""></a></figure>
                                        <div class="ritekhela-shop-grid-text">
                                    ...
                                    <li class="col-md-6">
                                        <figure><a href="#"><img src="extra-images/shop-grid-img9.jpg" alt=""></a></figure>
                                        <div class="ritekhela-shop-grid-text">
                                            <h2><a href="#">Sports Cup</a></h2>
                                            <span class="price-cart"><del>$ 30.00</del> $19.00</span>
                                            <p>Lorem ipsum dolor sit amet, consectet adipiscing elit. Vestibulum a nunc du rabitur dignissim.</p>
                                    ...
                                    <li class="col-md-6">
                                        <figure><a href="#"><img src="extra-images/shop-grid-img10.jpg" alt=""></a></figure>
                                        <div class="ritekhela-shop-grid-text">
                                            <h2><a href="#">Sports Tshirt</a></h2>
                                            <span class="price-cart"><del>$ 30.00</del> $19.00</span>
                                            <p>Lorem ipsum dolor sit amet, consectet adipiscing elit. Vestibulum a nunc du rabitur dignissim.</p>
